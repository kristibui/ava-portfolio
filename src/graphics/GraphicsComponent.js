...
const GraphicsComponent = () => {
    ...
    return(
        ...
        <p>Some of my data visualization journalism below, including pieces 
            from the <a className='article-headline' target='_blank' href='https://www.nytimes.com/by/ava-sasani'>The New York Times</a> and <a className='article-headline' href='https://www.theguardian.com/'>The Guardian</a>.
        </p>
